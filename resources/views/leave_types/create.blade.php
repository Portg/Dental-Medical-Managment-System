    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"> Leave Types Form </h4>
            </div>
            <div class="modal-body">
                ...
                <form action="#" id="leave-types-form" autocomplete="off">
                    ...
                    <div class="form-group">
                        <label class="text-primary">Maximum Leave Days </label>
                        <input type="text" name="max_days" placeholder="No of days" class="form-control">
                    </div>
                </form>
