{{-- SuperAdmin Sidebar Menu - Layout4 --}}
        ...
        <ul class="page-sidebar-menu page-header-fixed" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
            ...
            <li class="nav-item">
                ...
                <ul class="sub-menu">
                    ...
                    <li class="nav-item"><a href="{{ url('doctor-claims') }}" class="nav-link"><i class="icon-paper-clip"></i><span class="title">{{ __('menu.doctor_claims') }}</span></a></li>
                    <li class="nav-item"><a href="{{ url('claim-rates') }}" class="nav-link"><i class="icon-calculator"></i><span class="title">{{ __('menu.claim_rates') }}</span></a></li>
            ...
            <li class="nav-item">
                ...
                <ul class="sub-menu">
                    ...
                    <li class="nav-item"><a href="{{ url('users') }}" class="nav-link"><i class="icon-user"></i><span class="title">{{ __('menu.system_users') }}</span></a></li>
