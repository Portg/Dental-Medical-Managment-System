{{-- Admin Sidebar Menu - Layout4 (3-Level) --}}
<div class="page-sidebar-wrapper">
    <div class="page-sidebar navbar-collapse collapse">
        <ul class="page-sidebar-menu page-header-fixed" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
            ...
            {{-- 4. Operations Center (Admin: no doctor-claims, claim-rates, commission-rules) --}}
            <li class="nav-item">
                <a href="javascript:;" class="nav-link nav-toggle">
                ...
                <ul class="sub-menu">
                    ...
                    <li class="nav-item">
                        <a href="{{ url('insurance-companies') }}" class="nav-link">
            ...
            {{-- 6. System Settings (Admin: no role-permissions) --}}
            <li class="nav-item">
                <a href="javascript:;" class="nav-link nav-toggle">
                ...
                <ul class="sub-menu">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-menu">
                            <li class="nav-item"><a href="{{ url('users') }}" class="nav-link"><span class="title">{{ __('menu.users') }}</span></a></li>
