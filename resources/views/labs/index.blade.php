        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-dark">
                    <span class="caption-subject">{{ __('lab_cases.lab_list') }}</span>
                </div>
                <div class="actions">
                    <a href="#" onclick="createLab()" class="btn btn-sm green">
                        <i class="fa fa-plus"></i> {{ __('lab_cases.add_lab') }}
                    </a>
                    <a href="{{ url('lab-cases') }}" class="btn btn-sm blue">
                        <i class="fa fa-list"></i> {{ __('lab_cases.lab_cases') }}
                    </a>
                </div>
            </div>
            <div class="portlet-body">
                <table class="table table-striped table-bordered table-hover" id="labs-table">
                    <thead>
                    <tr>
