{{-- FDI dental chart: pick tool → paint teeth (same mental model as medical-case tooth picker) --}}
@php
...
<div id="dce-editor" class="dce-wrap">
    {{-- Step 1: pick tool --}}
    <section class="dce-step dce-ready" id="dce-status-step" aria-labelledby="dce-step-status-title">
        <header class="dce-step-head">
            ...
            <span class="dce-tool-chip is-empty" id="dce-tool-chip">
                <span class="dce-tool-swatch" id="dce-tool-swatch"></span>
                <span id="dce-tool-label">{{ __('odontogram.pick_tool') }}</span>
            </span>
        </header>
    ...
    <section class="dce-step dce-step-teeth" aria-labelledby="dce-step-teeth-title">
        <header class="dce-step-head">
            ...
            <h3 id="dce-step-teeth-title" class="dce-step-title">{{ __('odontogram.step_paint_teeth') }}</h3>
            <div class="dce-tabs">
