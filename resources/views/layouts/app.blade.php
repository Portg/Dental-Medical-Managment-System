                        ...
                        <div class="hor-menu  ">
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li aria-haspopup="true" class="menu-dropdown classic-menu-dropdown ">
                                    ...
                                    <ul class="dropdown-menu pull-left">
                                        <li aria-haspopup="true" class=" ">
                                            <a href="{{ url('expense-categories') }}" class="nav-link  ">Expenses
                                                Categories </a>
                                        </li>
                                        <li aria-haspopup="true" class=" ">
                                        ...
                                        <li aria-haspopup="true" class=" ">
                                            <a href="{{ url('expenses') }}" class="nav-link  ">View Expenses </a>
                                        </li>
                                ...
                                {{--                                        </li>--}}
                                {{--                                        --}}{{--                                        <li aria-haspopup="true" class="">--}}
                                {{--                                        --}}{{--                                            <a href="{{ url('doctor-claims') }}" class="nav-link  ">Claims--}}
                                {{--                                        --}}{{--                                                Management </a>--}}
                                {{--                                        --}}{{--                                        </li>--}}
                                {{--                                    </ul>--}}
                                {{--                                </li>--}}
                                {{--                                <li aria-haspopup="true" class="menu-dropdown classic-menu-dropdown ">--}}
                                {{--                                    <a href="javascript:;"> Leave Requests--}}
                                {{--                                        <span class="arrow"></span>--}}
                                {{--                                    </a>--}}
                                {{--                                    <ul class="dropdown-menu pull-left">--}}
                                {{--                                        <li aria-haspopup="true" class=" ">--}}
                                {{--                                            <a href="{{ url('leave-requests') }}" class="nav-link  ">My Leave Requests--}}
                                {{--                                            </a>--}}
                                {{--                                        </li>--}}
                                {{--                                    </ul>--}}
                                {{--                                </li>--}}
                                ...
                                <li aria-haspopup="true" class="menu-dropdown classic-menu-dropdown ">
                                    ...
                                    <ul class="dropdown-menu pull-left">
                                        <li aria-haspopup="true" class=" ">
                                            <a href="{{ url('clinic-services') }}" class="nav-link  ">Clinic
                                                Procedures </a>
                                        </li>
                                        <li aria-haspopup="true" class=" ">
                        ...
                        <div class="container">
                            ...
                            <div class="page-title">
                                <h4><a href="{{ url('profile') }}">My Profile</a>/
                                    ...
                                    <span class="text-primary">[ {{  Auth::User()->UserRole->name }} - <span> {{ Auth::User()->branch->name }}</span>]</span>
