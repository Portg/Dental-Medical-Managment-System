...
@section('page_js')
<script>
window.InvoicePaymentsReportConfig = { ajaxUrl: '{{ url('/invoice-payments-report') }}' };
</script>
<script src="{{ asset('include_js/invoice_payments_report.js') }}?v={{ filemtime(public_path('include_js/invoice_payments_report.js')) }}"></script>
@endsection
