        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-dark">
                    <span class="caption-subject">{{ __('branches.branches_management') }}</span>
                </div>
            </div>
            <div class="portlet-body">
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column"
                    ...
                    <tr>
                        <th>{{ __('common.id') }}</th>
                        <th>{{ __('branches.added_date') }}</th>
                        <th>{{ __('branches.name') }}</th>
                        <th>{{ __('branches.added_by') }}</th>
                        <th>{{ __('branches.status') }}</th>
                        <th>{{ __('branches.edit') }}</th>
                        <th>{{ __('branches.delete') }}</th>
                    </thead>
                    <tbody>
    ...
    <script type="text/javascript">
        ...
        function deleteRecord(id) {
            swal({
                    ...
                    text: "{{ __('branches.delete_confirm_message') }}",
                    type: "warning",
        ...
        function alert_dialog(message, status) {
            ...
            if (status) {
                let oTable = $('#branches_table').dataTable();
                oTable.fnDraw(false);
            }
        }
