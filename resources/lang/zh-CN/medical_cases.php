...
return [
    ...
    'plan_name' => '计划名称',
    'plan_overview' => '计划概览',
    'plan_overview_help' => '先明确计划名称，便于医生、前台与治疗团队快速识别当前方案。',
    'plan_execution' => '执行设置',
    'plan_execution_help' => '集中设置优先级、状态、日期与费用，减少来回扫描。',
    'plan_details' => '计划内容',
    'plan_details_help' => '将核心操作安排与补充说明分开记录，录入更清晰。',
    'completion_information' => '完成信息',
    'completion_information_help' => '仅在计划完成时填写实际结果，避免干扰主表单流。',
    'description' => '描述',
    'plan_description_help' => '记录补充背景、协作提醒或对外不可见的内部说明。',
    'planned_procedures' => '计划操作',
    'planned_procedures_placeholder' => '列出将要执行的操作...',
    'planned_procedures_help' => '填写拟执行的诊疗步骤、阶段安排或关键操作要点。',
    'estimated_cost' => '预估费用',
    'actual_cost' => '实际费用',
    'start_date' => '开始日期',
    ...
    'completion_notes_help' => '补充记录完成结果、调整原因或交付说明。',
    'priority' => '优先级',
