...
return [
    ...
    */
    ...
    'patient_has_invoices' => '此患者有账单记录，无法删除。',
    ...
    'batch_actions' => '批量操作',
    'batch_set_tags' => '设置标签',
    'batch_set_group' => '移入分组',
    'batch_remove_group' => '移出分组',
    'batch_tag_mode' => '标签模式',
    'batch_tag_append' => '追加到现有标签',
    'batch_tag_replace' => '替换现有标签',
    'batch_tags_updated' => '已更新 :count 位患者的标签',
    'batch_group_updated' => '已更新 :count 位患者的分组',
    'batch_confirm_remove_group' => '确定要将选中患者移出当前分组吗？',

    // Advanced Filters
    'age_range' => '年龄范围',
    'spending_range' => '消费金额范围',
    'min_placeholder' => '最小',
    'max_placeholder' => '最大',
    'min_amount' => '最低',
    'max_amount' => '最高',
    ...
    // Patient Import
    'import_patients' => '批量导入患者',
    'download_template' => '下载导入模板',
    'upload_file' => '上传文件',
    'import_hint_required' => '姓名、性别、手机号码为必填项',
    'import_hint_header' => '首行为表头，从第二行开始填入数据',
    'import_hint_limit' => '单次最多导入 500 条',
    'import_supported_formats' => '支持 .xlsx .xls .csv 格式',
    'import_result' => '导入结果',
    'import_success_count' => '成功导入 :count 条',
    'import_fail_count' => ':count 条失败',
    'import_row_error' => '第:row行',
    'import_file_required' => '请选择要导入的文件',
    'import_file_too_large' => '文件大小不能超过 5MB',
    'import_processing' => '正在导入，请稍候...',
    'import_invalid_gender' => '性别格式不正确，请填写"男"或"女"',
    'import_exceed_limit' => '数据行数超过限制（最多 :limit 条）',
    'import_template_filename' => '患者导入模板',
    'import_start' => '开始导入',
    'notes_short' => '备注',
    ...
    'merge_patients' => '合并患者',
    'merge_preview' => '合并预览',
    'merge_primary' => '主记录（保留）',
    'merge_secondary' => '副记录（将被合并）',
    'merge_select_exactly_two' => '请恰好勾选 2 位患者进行合并',
    'merge_swap' => '切换主副',
    'merge_field_compare' => '字段对比',
    'merge_no_diff' => '两位患者信息完全一致',
    'merge_warning' => '合并后，副记录的所有关联数据将迁移到主记录，副记录标记为已合并。此操作不可逆。',
    'merge_related_data' => '关联数据将迁移',
    'merge_success' => '患者合并成功',
    'merge_failed' => '患者合并失败，请重试',
    'merge_appointments' => '预约',
    'merge_invoices' => '账单',
    'merge_cases' => '病例',
    'merge_images' => '影像',
    'merge_followups' => '随访',
