...
return [
    ...
    'plan_overview_help' => 'Start with a clear plan name so clinical and front-desk teams can identify the treatment at a glance.',
    'plan_execution' => 'Execution Settings',
    'plan_execution_help' => 'Keep priority, status, dates, and cost settings together for faster review.',
    'plan_details' => 'Plan Details',
    'plan_details_help' => 'Separate core treatment actions from supporting notes to improve scanning.',
    'completion_information' => 'Completion Information',
    'completion_information_help' => 'Only fill in final outcomes when the plan is completed, so the main form stays focused.',
    'description' => 'Description',
    'plan_description_help' => 'Use for supporting context, team reminders, or internal notes.',
    'planned_procedures' => 'Planned Procedures',
    'planned_procedures_placeholder' => 'List procedures to be performed...',
    'planned_procedures_help' => 'Outline treatment steps, phases, or key clinical actions to be carried out.',
    ...
    'completion_notes_help' => 'Capture completion outcomes, changes made, or handoff notes.',
    'priority' => 'Priority',
    'save_treatment_plan' => 'Save Treatment Plan',
