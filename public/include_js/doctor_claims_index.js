...
$(function () {
    ...
    dataTable = $('#doctor_claims_table').DataTable({
        ...
        ajax: {
            url: window.DoctorClaimsConfig.indexUrl,
            data: function (d) {
            }
        },
        dom: 'rtip',
...
function save_data() {
    ...
    if (save) {
        ...
        if (amount === $('#claim_amount').val()) {
            ...
            swal(LanguageManager.trans('common.alert'), LanguageManager.trans('doctor_claims.amounts_not_matching'));
        }
...
function deleteRecord(id) {
    swal({
            ...
            text: LanguageManager.trans('doctor_claims.delete_confirm_message'),
            type: "warning",
