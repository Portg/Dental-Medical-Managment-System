/**
 * Quotation Conversion Report — page script
 * PHP values bridged via window.QuotationConversionConfig (set in Blade).
 * Translations loaded via LanguageManager.loadFromPHP() (set in Blade).
 */
$(document).ready(function () {
    var cfg = window.QuotationConversionConfig || {};
    ...
    new Chart(document.getElementById('monthlyTrendChart').getContext('2d'), {
        ...
        data: {
            ...
            datasets: [{
                label: LanguageManager.trans('report.total_quoted'),
                ...
                label: LanguageManager.trans('report.total_converted'),
